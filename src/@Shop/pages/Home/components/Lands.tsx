...
export default function Lands() {
  ...
  return (
    <>
      <h2 className="p-6 pixel font-bold text-center bg-white text-[1.6rem] mx-12 rounded-lg shadow-sank border text-blue-500">
        My IsLands
      </h2>
...
export function LoadingLand() {
  return (
    <div className="flex flex-col gap-20 p-20 bg-white rounded-md drop-shadow-lg ">
      <div className="relative rounded-md shadow-sank aspect-square animate-pulse">
...
export function LandCard(props: any) {
  return (
    <div className="relative flex flex-col gap-20 transition-all duration-300 bg-white rounded-lg shadow-lg group hover:shadow-2xl">
      <div className="relative overflow-hidden rounded-md shadow-sank aspect-square md:grayscale-[20%] group-hover:grayscale-0">
        <Image
          src={props?.image}
      ...
      <div className="absolute pixel  text-white top-6 right-6 bg-secondaryGradient text-[1.2rem] md:text-[1.6rem] p-6 rounded-md shadow-lg">
        #{props?.landId}
      </div>
    </div>
  );
